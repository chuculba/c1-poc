    ...
    <Body>
         <NS1:GetAddressResponse xmlns:NS1="urn:suncorp-com-au:schema:enterprise:getaddress:2012:05">
            ...
            <NS1:ProductSystemCustomer>
                ...
                <NS1:CustomerAccountName>Mr Delayed</NS1:CustomerAccountName>
                <NS1:Address>
                    <NS1:Type>ST</NS1:Type>
                    <NS1:AddressLine1>James Delayed</NS1:AddressLine1>
                    <NS1:AddressLine2>My Delayed</NS1:AddressLine2>
                    <NS1:AddressLine3>3 Delayedy Place</NS1:AddressLine3>
                ...
                <NS1:Product>
                    ...
                    <NS1:Address>
                        ...
                        <NS1:AccountName>Mr Delayed</NS1:AccountName>
                        <NS1:Risk>
