...
<Message>
    ...
    <Warning>
        <Number>12345</Number>
        <Description>Account <xsl:value-of select="//urn:CustomerID"/> will expire in 3 days</Description>
        <SourceApplication>CCC</SourceApplication>
    </Warning>    
    <Body>
         <NS1:GetAddressResponse xmlns:NS1="urn:suncorp-com-au:schema:enterprise:getaddress:2012:05">
            ...
            <NS1:ProductSystemCustomer>
                ...
                <NS1:CustomerAccountName>Mr Expired</NS1:CustomerAccountName>
                <NS1:Address>
                    <NS1:Type>ST</NS1:Type>
                    <NS1:AddressLine1>James Expired</NS1:AddressLine1>
                ...
                <NS1:Product>
                    ...
                    <NS1:Address>
                        ...
                        <NS1:AccountName>Mr Expired</NS1:AccountName>
                        <NS1:Risk>
